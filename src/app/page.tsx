...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
            <Image 
                ...
                fill
                className="object-cover brightness-[0.4]" // Gelapkan gambar 60% agar teks terbaca
                priority
            />
        </div>
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto mt-16">
            <span className="bg-green-500 text-white text-xs font-bold px-3 py-1 rounded-full uppercase tracking-widest mb-4 inline-block">
                Premium Mini Soccer
            </span>
            <h1 className="mb-6 text-5xl font-extrabold tracking-tight leading-none text-white md:text-7xl">
                Main Seperti <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-600">Bintang Liga</span>
            </h1>
            <p className="mb-8 text-lg font-light text-gray-300 lg:text-xl sm:px-16 lg:px-48">
                Rasakan kualitas rumput standar FIFA, pencahayaan stadion profesional, dan fasilitas lengkap. Waktunya tunjukkan skill terbaikmu.
            </p>
            <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                <Link href="#booking-area" className="inline-flex justify-center items-center py-4 px-8 text-base font-bold text-center text-black rounded-full bg-white hover:bg-gray-200 transition transform hover:scale-105 shadow-lg shadow-white/20">
                    Booking Sekarang
                </Link>
            </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-xl transition duration-300 text-center group">
                    <div className="w-20 h-20 bg-green-100 rounded-2xl flex items-center justify-center mx-auto mb-6 text-4xl group-hover:scale-110 transition">
                        🌱
                    </div>
                    <h3 className="text-xl font-bold mb-3 text-gray-900">Rumput Standar FIFA</h3>
                    <p className="text-gray-500 leading-relaxed">Menggunakan rumput sintetis monofilamen import yang empuk, aman saat jatuh, dan bola bergulir akurat.</p>
                </div>
                {/* Feature 2 */}
                <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-xl transition duration-300 text-center group">
                    <div className="w-20 h-20 bg-blue-100 rounded-2xl flex items-center justify-center mx-auto mb-6 text-4xl group-hover:scale-110 transition">
                        💡
                    </div>
                    <h3 className="text-xl font-bold mb-3 text-gray-900">Lighting Pro 300 Lux</h3>
                    <p className="text-gray-500 leading-relaxed">Main malam hari seterang siang hari. Lampu LED disusun merata tanpa bayangan yang mengganggu pandangan.</p>
                </div>
                {/* Feature 3 */}
                <div className="bg-white p-8 rounded-3xl shadow-sm hover:shadow-xl transition duration-300 text-center group">
                    <div className="w-20 h-20 bg-orange-100 rounded-2xl flex items-center justify-center mx-auto mb-6 text-4xl group-hover:scale-110 transition">
                        🚿
                    </div>
                    <h3 className="text-xl font-bold mb-3 text-gray-900">Fasilitas Premium</h3>
                    <p className="text-gray-500 leading-relaxed">Kamar bilas air hangat, loker aman, mushola bersih, dan area kantin untuk nongkrong setelah main.</p>
                </div>
            </div>
        </div>
      </section>

      {/* 4. BOOKING SECTION (Daftar Lapangan yang Anda buat) */}
      <section id="booking-area" className="py-24 bg-white relative">
        <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
                <span className="text-green-600 font-bold tracking-wider uppercase text-sm">Jadwal Tersedia</span>
                <h2 className="text-4xl font-extrabold text-gray-900 mt-2">Pilih Lapangan Favoritmu</h2>
                <p className="text-gray-500 mt-4 max-w-2xl mx-auto">Kami menyediakan berbagai tipe lapangan sesuai gaya bermain tim Anda. Klik tombol booking untuk mengamankan jadwal.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {fields.map((field) => (
                // Container Kartu dengan Hover Effect
                    ...
                    <div className="p-8 flex-1 flex flex-col relative bg-white">
                        ...
                        <div className="pt-6 border-t border-gray-100 mt-auto relative z-20">
                            <div className="flex items-center justify-between">
                                ...
                                {/* TOMBOL BOOKING (Sesuai perbaikan Z-Index kita sebelumnya) */}
                                <Link 
                                    href={`/field/${field.id}`} 
        ...
        <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
                ...
                <p className="text-gray-400 text-sm leading-relaxed max-w-sm">
                    Platform booking mini soccer modern. Kami berkomitmen menyediakan pengalaman bermain bola yang profesional, mudah, dan menyenangkan bagi semua kalangan.
                </p>
            </div>
            <div>
            ...
            <div>
                ...
                <ul className="space-y-2 text-gray-400 text-sm">
                    <li className="flex items-start gap-2">
                        <span>📍</span> Jl. Sudirman No. 1, Jakarta
                    </li>
                    <li className="flex items-center gap-2">
                        <span>📞</span> +62 812-3456-7890
                    </li>
                    <li className="flex items-center gap-2">
                        <span>✉️</span> booking@sportcenter.com
                    </li>
                </ul>
            </div>
        </div>
      ...
      <a
        href="https://wa.me/6285117692051?text=Halo%20Admin,%20saya%20tertarik%20booking%20lapangan,%20bisa%20info%20lebih%20lanjut?"
        target="_blank"
      ...
      >
        ...
        <div className="bg-[#25D366] hover:bg-[#20bd5a] text-white p-4 rounded-full shadow-2xl transition transform hover:scale-110 flex items-center justify-center w-16 h-16">
          ...
          {/* Titik Notifikasi Berkedip (Efek Online) */}
