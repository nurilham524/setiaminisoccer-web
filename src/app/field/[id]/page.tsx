...
export default async function Page({ params }: PageProps) {
    ...
    const price = typeof field.pricePerHour === "number" ? field.pricePerHour : Number(field.pricePerHour);
                ...
                <div className="md:col-span-2 relative z-10">
                    <div className="rounded-xl overflow-hidden shadow-md bg-gray-50 border border-gray-100">
                        <Image
                            ...
                            width={1600}
                            height={900}
                            className="w-full h-80 object-cover md:h-[30rem]"
                            priority
                        />
                    </div>
                    ...
                    <div className="mt-8">
                        ...
                        <p className="mt-2 text-2xl font-bold text-green-600">
                            Rp {price.toLocaleString('id-ID')} <span className="text-sm text-gray-500 font-normal">/ jam</span>
                        </p>
                ...
                <aside className="md:col-span-1 relative z-20">
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-lg sticky top-6">
                        <div className="border-b pb-4 mb-4">
                            <h2 className="text-xl font-bold text-gray-900">Jadwal & Booking</h2>
