    ...
    <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-8">
      ...
      <div className="md:col-span-8 bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex gap-6 text-xs font-medium flex-wrap text-gray-800">
        ...
        {loading ? (
            ...
            <div className="text-center py-12 text-gray-500 bg-gray-50 rounded-lg">
                <p className="font-medium">Tidak ada lapangan tersedia</p>
                <p className="text-sm text-gray-400 mt-1">Tambahkan lapangan untuk memulai</p>
            </div>
        ) : (
